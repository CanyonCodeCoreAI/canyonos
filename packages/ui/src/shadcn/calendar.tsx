...
function CalendarDayButton({
  className,
  // Destructured so it stays out of the DOM spread; the td above already carries the ISO data-day.
  day: _day,
  modifiers,
  ...props
  ...
  // react-day-picker moves its roving tabindex by marking a day focused; the DOM focus has to
  // follow, or arrow keys walk the grid without the reader's caret going anywhere.
